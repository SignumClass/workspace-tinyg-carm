...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-carm |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-carm"], // the id you gave your workspace
      function(myWorkspaceCarm) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / TinyG Carm just got loaded.", myWorkspaceCarm);
        myWorkspaceCarm.init();
      }
    );
  }
);
