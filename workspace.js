...
cprequire_test(["inline:com-chilipeppr-workspace-tinygcarm"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-tinygcarm", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-tinygcarm", // Make the id the same as the cpdefine id
